 ...
 * xen_bitops.h
 * 
 * collection of macros and definition for bit operations
 */

#ifndef _XEN_BITOPS_H_
#define _XEN_BITOPS_H_
...
do {									\
	vcpu_info_t *_vcpu;						\
	_vcpu = &xen_shared_info->vcpu_info[smp_processor_id()];	\
